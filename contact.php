            ...
            <div class="row block-9">
                <div class="col-lg-8 order-md-last d-flex">
                    <form action="mail.php" method="POST" title="Contact Form" class="bg-light p-5 contact-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="citystate" title="City and State"
                                   placeholder="City/State">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="phone" title="Phone Number"
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="employer"
                                   title="Name of Employer at time of injury"
                                   placeholder="Name of Employer at time of injury">
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control" name="doi" title="Date of injury"
                                   placeholder="Date of injury">
                        </div>
                        <div class="form-group">
                            <textarea id="injury" cols="30" rows="7" class="form-control" name="injury"
                                      title="Describe injury or condition"
                ...
                <div class="col-lg-4">
                    ...
                    <ul>
                        ...
                        <li><a target="_blank" href="pdf/Treatment-Medication%20Denial%20form%202016.pdf">Treatment
                                denial form</a></li>
                        <li><a target="_blank" href="pdf/Treatment-Medication%20Denial%20form%202016.pdf">Prescription
                                denial form</a></li>
