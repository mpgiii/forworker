      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-10 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
			...
			<h2 class="subheading" data-scrollax="properties: { translateY: '30%', opacity: .2 }"><br>Partners Michael P. Georgariou II and Nicholas J. Dilles have the reputations for quality trial skills and in-depth knowledge of California workers' compensation laws. We also provide legal services related to Social Security disability claims.<br></h2>
            <p><br><br><a href="contact.html" class="btn btn-primary py-3 px-4">Request a Free Consultation</a></p>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row no-gutters d-flex">
          ...
          <div class="col-md-3 text-center services align-self-stretch ftco-animate p-3">
            ...
            <div class="media-body">
              ...
              <p>The attorneys of Sprenkle, Georgariou & Dilles, LLP can assist you with your claim for Social Security Disability Insurance Benefits (SSDI) and Supplemental Security Income Benefits (SSI).</p>
            </div>
          </div>
          <div class="col-md-3 text-center services align-self-stretch ftco-animate p-3">
            ...
            <div class="media-body">
              ...
              <p>We have the reputations for quality trial skills and in-depth knowledge of California workers' compensation and social security laws.</p>
            </div>
          </div>
          <div class="col-md-3 text-center services align-self-stretch ftco-animate p-4">
            ...
            <div class="media-body">
              ...
              <p>There are some resources which may be helpful to look over before or during the pursual of an injured worker case.</p>
            </div>
          </div>
        </div>
      </div>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>Mr. Sprenkle, who retired as of May 31, 2019, was a certified specialist in Workers’ Compensation Law by the State Bar of California Board of Legal Specialization.<br>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
	                  <p>Mr. Georgariou is a certified specialist in Workers’ Compensation Law by the State Bar of California Board of Legal Specialization, and is bilingual (English-Spanish).<br>
	                ...
	                <div class="author d-flex">
	                  ...
	                  <div class="name align-self-center">Michael P. Georgariou II<span class="position">Partner</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
					<p>After graduating from law school, Mr. Dilles provided legal aid services at California Rural Legal Assistance in Watsonville, California before joining this law firm.<br>
	                ...
	                <div class="author d-flex">
	                  ...
	                  <div class="name align-self-center">Nicholas J. Dilles <span class="position">Partner</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  ...
	                  <div class="name align-self-center">Samuel J. Lawrence <span class="position">Associate Attorney</span></div>
	                </div>
	              </div>
	            </div>
	          </div>
