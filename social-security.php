      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5 text-center">
            ...
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="practice-areas.html">Practice Areas <i class="ion-ios-arrow-forward"></i></a></span> <span>Social Security Disability <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 order-md-last ftco-animate">
			...
			<p>If you have a disability that has lasted or is expected to last at least 12 months, you may be entitled to SSDI and/or SSI benefits.</p>
            <h4 class="mb-3">Do You Have a SSDI case?</h2>
            <p>In order to qualify for SSDI benefits, you must have worked and paid into Social Security. In order to qualify for SSI benefits, there is no such requirement. SSI benefits are based on financial need and are available to individuals with very low assets. SSDI benefits are typically paid at a higher rate than SSI benefits.</p>
            <p>In determining whether an individual is disabled for purposes of SSDI and SSI, the Social Security Administration must conclude that you have a medically determinable physical or mental impairment which can be expected to result in death or which has lasted or can be expected to last for a continuous period of 12 months or more.</p>

			<h5 class="mb-3">In addressing entitlement to SSDI and SSI benefits, the Social Security Administration considers a sequential evaluation as follows:</h2>
			<ul>
