            ...
            <div class="row no-gutters slider-text align-items-end justify-content-center">
                <div class="col-md-9 ftco-animate pb-5 text-center">
                    ...
                    <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home <i
                                    ...
                                    href="team.html">Our Team <i class="ion-ios-arrow-forward"></i></a></span> <span>Samuel J. Lawrence <i
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-sm-6">
                    ...
                    <p>Mr. Lawrence grew up in New England and spent seven years in Boston for school
                        before moving to California. He has lived in the Monterey area since 2015.</p>
                    <h5 class="mb-3">Personal:</h5>
                    <p>Mr. Lawrence enjoys going to the beach and the gym, long distance runs on the
                        Monterey Peninsula on Saturday and Sunday mornings, day-hikes, playing
                        pickup basketball, watching the Celtics and Patriots, listening to podcasts
                        about sports and politics, and reading sci-fi and fantasy novels.</p>
                </div>
