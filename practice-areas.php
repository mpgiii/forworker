        ...
        <div class="row d-flex justify-content-center">
        	<div class="col-md-4 col-lg-3 text-center">
        		<div class="practice-area bg-white ftco-animate p-4">
        			...
        			<p>Helping injured workers obtain the workers' compensation benefits which they are legally owed.</p>
        		</div>
        	</div>
        	<div class="col-md-4 col-lg-3 text-center">
        		<div class="practice-area bg-white ftco-animate p-4">
        			...
        			<p>Helping workers with their claims for Social Security Disability Insurance Benefits (SSDI) and Supplemental Security Income Benefits (SSI).</p>
        		</div>
        	</div>
        	<div class="col-md-4 col-lg-3 text-center">
        		<div class="practice-area bg-white ftco-animate p-4">
        			...
        			<p>Helping workers with the inability to perform the usual job duties due to a work-related injury or illness.</p>
        		</div>
        	</div>
